...
describe LocalesController do
  ...
  describe "GET index" do
    it "assigns all locales as @locales" do
      ...
      assigns(:locales).should eq([locale])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested locale as @locale" do
      ...
      assigns(:locale).should eq(locale)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new locale as @locale" do
      ...
      assigns(:locale).should be_a_new(Locale)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created locale as @locale" do
        post :create, {:locale => valid_attributes}, valid_session
        assigns(:locale).should be_a(Locale)
        assigns(:locale).should be_persisted
      end

      it "redirects to the created locale" do
        post :create, {:locale => valid_attributes}, valid_session
        response.should redirect_to(Locale.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved locale as @locale" do
        ...
        Locale.any_instance.stub(:save).and_return(false)
        post :create, {:locale => { "name" => "invalid value" }}, valid_session
        assigns(:locale).should be_a_new(Locale)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested locale" do
        locale = Locale.create! valid_attributes
        # Assuming there are no other locales in the database, this
        # specifies that the Locale created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Locale.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => locale.to_param, :locale => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the locale" do
        locale = Locale.create! valid_attributes
        put :update, {:id => locale.to_param, :locale => valid_attributes}, valid_session
        response.should redirect_to(locale)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the locale as @locale" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Locale.any_instance.stub(:save).and_return(false)
        put :update, {:id => locale.to_param, :locale => { "name" => "invalid value" }}, valid_session
        assigns(:locale).should eq(locale)
      end
